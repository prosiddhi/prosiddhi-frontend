...
/**
 * The conversation list + active thread — everything below the header. Shared
 * by both role routes (`/messages` for a seeker, `/employer/messages` for an
 * employer): same chat feature either side, only the surrounding chrome
 * differs, and each page supplies its own header/ProtectedRoute for that.
 *
