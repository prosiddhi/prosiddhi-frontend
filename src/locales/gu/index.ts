// Barrel for the `gu` locale — generated, but safe to edit by hand.
//
// Each locale gets one module so `import('@/locales/gu')` produces exactly one
