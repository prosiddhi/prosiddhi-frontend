// Barrel for the `kn` locale — generated, but safe to edit by hand.
//
// Each locale gets one module so `import('@/locales/kn')` produces exactly one
