    ...
    const run = async () => {
      ...
      try {
        ...
        setInitial({
          ...
          duration: (job.duration as string | undefined) ?? undefined,
          numberOfPositions: (job.numberOfPositions as number | undefined) ?? undefined,
          expiresAt: (job.expiresAt as string | undefined) ?? undefined,
