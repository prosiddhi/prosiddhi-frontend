      ...
      <main className="flex-1 py-6 sm:py-8 lg:py-12">
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[120px]">
          ...
          <div className="bg-white rounded-[10px] mb-8 sm:mb-10 lg:mb-12">
            <div className="flex flex-col lg:flex-row lg:items-start gap-6 lg:gap-8">
              ...
              <div className="flex flex-col items-end gap-4 lg:min-w-[300px]">
                ...
                <div className="px-6 py-3 bg-[#22c55e] text-white rounded-lg flex items-center justify-center gap-2 min-w-[140px]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-12 sm:mb-16 lg:mb-20">
            <div className="px-6 sm:px-8 py-3 bg-[#22c55e] text-white rounded-lg flex items-center justify-center gap-2">
              <CheckCircle2 className="w-5 h-5" />
              <span className="text-sm sm:text-base font-medium">Applied</span>
            </div>
