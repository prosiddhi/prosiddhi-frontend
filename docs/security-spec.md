...
**Anchors:** [PRODUCT.md §5 (locked scope)](PRODUCT.md) (D2 + Q3 + module inventory) and the live BE code in `prosiddhi-backend/src/` (the authoritative "what is built today").
...
If anything here conflicts with [PRODUCT.md §5 (locked scope)](PRODUCT.md), scope-locked wins and this file gets updated. If anything here conflicts with the BE code (`prosiddhi-backend/src/`), the BE code wins for "what is built today" and this file gets updated; this file wins for "what we are committing to build."
