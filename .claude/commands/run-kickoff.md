...
2. `docs/execution-playbook.md` — the live execution tracker (what's done / build next), with the status-reconciliation analysis as Appendix A.
...
Then produce the **pending-work list**: from `docs/execution-playbook.md`, list the next unchecked `[ ]` tickets in order (Stage 1 → 2 → 3), with any blocker noted. Format:
